...
/**
 * test the main procedure of thor swap
 */
contract("ThorNetworkProxy", async function(accounts) {
    ...
    it("reserve withdraw tokens and ether", async function() {
        ...
        await thorReserve.withdrawToken(token1Addr, web3.toWei(1, 'ether'), acc3);
        ...
        assert.equal(token1Balanceb.minus(token1Balance).valueOf(), web3.toWei(1, 'ether'), "token withdraw failed");
